...
import './Footer.css'
import { EmailIcon, FacebookIcon, LinkedinIcon, TelephoneIcon, TwitterIcon, WhatsappIcon } from '../../utilitis/icons';
    ...
    <div className='footer'>
      <div>
        ...
        <div className='footer-item-section'>
          ...
          <div>
            <h2 className='header-item-title text-lime-800'>Our Solution</h2>
          ...
          <div>
            <h2 className='header-item-title text-lime-800'>Your needs</h2>
            <li className='text-lime-800'>Core Features</li>
            <li className='text-lime-800'>Product Features</li>
            <li className='text-lime-800'>Pricing</li>
          </div>
          ...
          <div>
            <h2 className='header-item-title text-lime-800'>Offer</h2>
            <li className='text-lime-800'>Core Features</li>
            <li className='text-lime-800'>Product Features</li>
            <li className='text-lime-800'>Pricing</li>
          </div>
